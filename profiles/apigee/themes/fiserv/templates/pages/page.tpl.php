...
<div class="master-container">
  <?php if (drupal_is_front_page()): ?>
    <section class="page-header">
      <div class="container">
      <section class="hero container video-container">
<video autoplay="" class="fillWidth" loop="" muted="" style="top: 0px;"><source src="images/banner-video.mp4" type="video/mp4" />Your browser does not support the video tag. We suggest you upgrade your browser. <source src="images/banner-video.mp4" type="video/webm" />Your browser does not support the video tag. We suggest you upgrade your browser.</video>
</section>
  ...
  <div class="test">
          <?php print render($page['test_bottom']); ?>
        </div>
  <div id="push"></div>
